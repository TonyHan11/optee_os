...
static struct clk *
at91_clk_register_utmi_internal(struct pmc_data *pmc, const char *name,
				const struct clk_ops *ops, struct clk *parent)
{
...
struct clk *
at91_clk_sama7g5_register_utmi(struct pmc_data *pmc, const char *name,
			       struct clk *parent)
{
